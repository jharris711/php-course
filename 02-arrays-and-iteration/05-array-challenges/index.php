...
$sum = array_sum($nums);
$length = count($nums);
echo '<h3>The sum of the ' . $length . ' numbers is: ' . $sum . '</h3>';
...
$jobListings = [
  ...
  [
    ...
    'job_title' => 'Gardener',
    'company' => 'Garden Inc.',
    'contact_email' => 'gardenboss@gmail.com',
    'contact_phone' => '123-456-7890',
    'skills' => ['Digging', 'Plant stuff', 'Dirt'],
  ],
  [
    'id' => 2,
    'job_title' => 'Jobless',
    ...
    'contact_email' => 'lol',
    'contact_phone' => '123-456-7890',
    'skills' => ['Gaming', 'Procrastination', 'Lazing about'],
  ],
];

array_push($jobListings, [
  'id' => 0,
  'job_title' => 'Roblox Millionaire',
  'company' => 'Acme Inc.',
  'contact_email' => 'me@gmail.com',
  'contact_phone' => '123-456-7890',
  'skills' => ['Lua', 'Roblox Studio', 'Robux'],
]);

echo '<h3>Job Title of Second Job Listing: ' . $jobListings[1]['job_title'] . '</h3>';
echo '<h3>First Skill of Third Job Listing: ' . $jobListings[2]['skills'][0] . '</h3>';
